...
public class Stream_03_Test {
    ...
    public void test_mapping() throws Exception {
        ...
        //Comparator comp = (c1,c2) -> c1.getGender().compare(c2.getGender());

        // TODO Construire la map Sexe -> Chaîne représentant les prénoms des clients
        Map<Gender, String> result = customers.stream().sorted(Comparator.comparing(Customer::getFirstname)).collect(Collectors.toMap(c -> c.getGender(), c -> c.getFirstname(),(s1,s2) -> s1+"|"+s2));
